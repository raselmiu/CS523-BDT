...
public class AvroStationMaxTempYear extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(conf, new AvroStationMaxTempYear(), args);
        System.exit(res);
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(AvroStationMaxTempYear.class);
    ...
    public static class AvroMapper extends Mapper<LongWritable, Text, AvroKey<GenericRecord>, NullWritable> {
        private final LineReaderUtils utils = new LineReaderUtils();
    ...
    public static class AvroReducer extends Reducer<AvroKey<GenericRecord>, NullWritable, AvroKey<GenericRecord>, NullWritable> {
        ...
        @Override
        protected void reduce(AvroKey<GenericRecord> key, Iterable<NullWritable> values, Context context)
                throws IOException, InterruptedException {
            GenericRecord record = key.datum();
            int year = Integer.parseInt(record.get("Year").toString());
            if (currentYear != year) {
                currentYear = year;
