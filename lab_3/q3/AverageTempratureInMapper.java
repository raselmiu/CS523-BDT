...
public class AverageTempratureInMapper extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        Job job = new Job(getConf(), "AverageTemperatureQ3");
        job.setJarByClass(AverageTempratureInMapper.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int runner = ToolRunner.run(conf, new AverageTempratureInMapper(), args);
