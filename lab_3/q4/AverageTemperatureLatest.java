...
public class AverageTemperatureLatest extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        Job job = new Job(getConf(), "AverageTemperatureQ4");
        job.setJarByClass(AverageTemperatureLatest.class);
        ...
        job.setSortComparatorClass(YearComparatorDesc.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int res = ToolRunner.run(conf, new AverageTemperatureLatest(), args);
        System.exit(res);
    }
}
